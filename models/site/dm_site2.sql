...
FROM (
    SELECT
        ...
        CASE
            ...
            WHEN UPPER(NVL(CITY.STNAME, 'NA')) IN ('ANDHRA PRADESH','TELANGANA') THEN 'SOUTH 2'
            WHEN UPPER(NVL(CITY.STNAME, 'NA')) IN ('KARNATAKA','KERALA','PUDUCHERRY','TAMIL NADU') THEN 'SOUTH 1'
